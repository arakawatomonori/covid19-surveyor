...
# 首相官邸
wget -l 1 -r --no-check-certificate http://www.kantei.go.jp/
# 内閣府
wget -l 1 -r --no-check-certificate https://www.cao.go.jp/
# 内閣府防災情報
wget -l 1 -r --no-check-certificate https://www.bousai.go.jp/
# 復興庁
wget -l 1 -r --no-check-certificate https://www.reconstruction.go.jp/
# 公正取引委員会
wget -l 1 -r --no-check-certificate https://www.jftc.go.jp/
# 日本学術会議
wget -l 1 -r --no-check-certificate http://www.scj.go.jp/
# 警察庁
wget -l 1 -r --no-check-certificate http://www.npa.go.jp/
# 金融庁
wget -l 1 -r --no-check-certificate https://www.fsa.go.jp/
# 消費者庁
wget -l 1 -r --no-check-certificate https://www.caa.go.jp/
# 総務省
wget -l 1 -r --no-check-certificate http://www.soumu.go.jp/
# 総務省消防庁
wget -l 1 -r --no-check-certificate https://www.fdma.go.jp/
# 法務省
wget -l 1 -r --no-check-certificate https://www.moj.go.jp/
# 外務省
wget -l 1 -r --no-check-certificate https://www.mofa.go.jp/
# 財務省
wget -l 1 -r --no-check-certificate https://www.mof.go.jp/
# 財務省 国税庁
wget -l 1 -r --no-check-certificate https://www.nta.go.jp/
# 文部科学省
wget -l 1 -r --no-check-certificate https://www.mext.go.jp/
# 文部科学省 文化庁
wget -l 1 -r --no-check-certificate https://www.bunka.go.jp/
# 厚生労働省
wget -l 1 -r --no-check-certificate https://www.mhlw.go.jp/
# 農林水産省
wget -l 1 -r --no-check-certificate https://www.maff.go.jp/
# 経済産業省
wget -l 1 -r --no-check-certificate https://www.meti.go.jp/
# 経済産業省 特許庁
wget -l 1 -r --no-check-certificate https://www.jpo.go.jp/
# 経済産業省 中小企業庁
wget -l 1 -r --no-check-certificate https://www.chusho.meti.go.jp/
# 国土交通省
wget -l 1 -r --no-check-certificate https://www.mlit.go.jp/
# 国土交通省 国土地理院
wget -l 1 -r --no-check-certificate https://www.gsi.go.jp/
# 国土交通省 気象庁
wget -l 1 -r --no-check-certificate https://www.jma.go.jp/
# 国土交通省 海上保安庁
wget -l 1 -r --no-check-certificate https://www.kaiho.milt.go.jp/
# 環境省
wget -l 1 -r --no-check-certificate https://www.env.go.jp/
# 環境省 原子力規制委員会
wget -l 1 -r --no-check-certificate https://www.nsr.go.jp/
# 防衛省
wget -l 1 -r --no-check-certificate https://www.mod.go.jp/

# 独立行政法人
# 中小企業基盤整備機構
wget -l 1 -r --no-check-certificate https://j-net21.smrj.go.jp/
...
wget -l 1 -r --no-check-certificate http://www.pref.fukui.lg.jp/
wget -l 1 -r --no-check-certificate http://www.pref.yamanishi.jp/
wget -l 1 -r --no-check-certificate http://www.pref.nagano.lg.jp/
...
wget -l 1 -r --no-check-certificate http://www.pref.osaka.lg.jp/
...
wget -l 1 -r --no-check-certificate http://www.pref.kumamoto.jp/
